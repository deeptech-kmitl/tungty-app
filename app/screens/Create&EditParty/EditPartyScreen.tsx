...
interface EditPartyScreenProps extends AppStackScreenProps<"EditParty"> { }

export const EditPartyScreen: FC<EditPartyScreenProps> = observer(function EditPartyScreen() {
  const handleSubmit = () => {
  ...
  return (
    <Screen style={$root} preset="scroll">
      ...
      <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
        <Button onPress={handleSubmit} text="Save" style={{ ...buttonStyle, marginRight: 10 }} textStyle={textButtonStyle} />
        <Button onPress={handleSubmit} text="Delete Party" style={{ ...buttonStyle, backgroundColor: 'red' }} textStyle={textButtonStyle} />
      </View>
    </Screen>
  );
});
